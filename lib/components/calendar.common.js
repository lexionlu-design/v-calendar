...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".vc-day[data-v-6fc83f6b]{position:relative;min-height:32px;z-index:1}.vc-day.is-not-in-month *[data-v-6fc83f6b]{opacity:0;pointer-events:none}.vc-day-layer[data-v-6fc83f6b]{position:absolute;left:0;right:0;top:0;bottom:0;pointer-events:none}.vc-day-box-center-center[data-v-6fc83f6b]{display:flex;justify-content:center;align-items:center;transform-origin:50% 50%}.vc-day-box-left-center[data-v-6fc83f6b]{display:flex;justify-content:flex-start;align-items:center;transform-origin:0 50%}.vc-day-box-right-center[data-v-6fc83f6b]{display:flex;justify-content:flex-end;align-items:center;transform-origin:100% 50%}.vc-day-box-center-bottom[data-v-6fc83f6b]{display:flex;justify-content:center;align-items:flex-end}.vc-day-content[data-v-6fc83f6b]{display:flex;justify-content:center;align-items:center;font-size:var(--text-sm);font-weight:var(--font-medium);width:28px;height:28px;line-height:28px;border-radius:var(--rounded-full);-webkit-user-select:none;user-select:none;cursor:pointer}.vc-day-content[data-v-6fc83f6b]:hover{background-color:rgba(204,214,224,.3)}.vc-day-content[data-v-6fc83f6b]:focus{font-weight:var(--font-bold);background-color:rgba(204,214,224,.4)}.vc-day-content.is-disabled[data-v-6fc83f6b]{color:var(--gray-400)}.vc-is-dark .vc-day-content[data-v-6fc83f6b]:hover{background-color:rgba(114,129,151,.3)}.vc-is-dark .vc-day-content[data-v-6fc83f6b]:focus{background-color:rgba(114,129,151,.4)}.vc-is-dark .vc-day-content.is-disabled[data-v-6fc83f6b]{color:var(--gray-600)}.vc-highlights[data-v-6fc83f6b]{overflow:hidden;pointer-events:none;z-index:-1}.vc-highlight[data-v-6fc83f6b]{width:28px;height:28px}.vc-highlight.vc-highlight-base-start[data-v-6fc83f6b]{width:50%!important;border-radius:0!important;border-right-width:0!important}.vc-highlight.vc-highlight-base-end[data-v-6fc83f6b]{width:50%!important;border-radius:0!important;border-left-width:0!important}.vc-highlight.vc-highlight-base-middle[data-v-6fc83f6b]{width:100%;border-radius:0!important;border-left-width:0!important;border-right-width:0!important;margin:0 -1px}.vc-dots[data-v-6fc83f6b]{display:flex;justify-content:center;align-items:center}.vc-dot[data-v-6fc83f6b]{width:5px;height:5px;border-radius:50%;transition:all var(--day-content-transition-time)}.vc-dot[data-v-6fc83f6b]:not(:last-child){margin-right:3px}.vc-bars[data-v-6fc83f6b]{display:flex;justify-content:flex-start;align-items:center;width:75%}.vc-bar[data-v-6fc83f6b]{flex-grow:1;height:3px;transition:all var(--day-content-transition-time)}", ""]);
// Exports
module.exports = exports;
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarDay_vue_vue_type_style_index_0_id_6fc83f6b_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("e8fc");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarDay_vue_vue_type_style_index_0_id_6fc83f6b_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarDay_vue_vue_type_style_index_0_id_6fc83f6b_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarDay_vue_vue_type_style_index_0_id_6fc83f6b_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// load the styles
var content = __webpack_require__("82d6");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("34473b18", content, true, {"sourceMap":false,"shadowMode":false});
  ...
  computed: {
    ...
    dayContentProps() {
      ...
      if (this.day.attributes.length) {
        isCurrent = Boolean(this.day.attributes.reduce(function (result, item) {
          return result || item.key === 'today';
        }, false));
        isSelected = Boolean(this.day.attributes.reduce(function (result, item) {
...
// EXTERNAL MODULE: ./src/components/CalendarDay.vue?vue&type=style&index=0&id=6fc83f6b&lang=postcss&scoped=true&
var CalendarDayvue_type_style_index_0_id_6fc83f6b_lang_postcss_scoped_true_ = __webpack_require__("8c5b");
